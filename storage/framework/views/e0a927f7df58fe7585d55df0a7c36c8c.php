        ...
        <?php if(!empty($cliente)): ?>
            <div class="content-grid">
                ...
                <div class="info-block">
                    ...
                    <p><strong> Data de Nascimento:</strong> <?php echo e($cliente->nascimento); ?></p>
                    <p><strong> CPF:</strong> <?php echo e($cliente->cpf); ?></p>
                    <p><strong> Endereço:</strong> <?php echo e($cliente->endereço ?? 'Não informado'); ?></p>
                    <p><strong> Contato:</strong> <?php echo e($cliente->numero ?? 'Não informado'); ?></p>

                    <?php if($cliente->valores->isNotEmpty()): ?>
                        <h3>🎁 Detalhes do Pacote</h3>
                        <div class="package-details">
                            <?php $__currentLoopData = $cliente->valores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $valor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <p><strong> Tipo:</strong> <?php echo e($valor->tipo); ?></p>
                                <p><strong> Descrição:</strong> <?php echo e($valor->descricao); ?></p>
                                <p><strong> Valor:</strong> <?php echo e($valor->valor); ?></p>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    <?php else: ?>
                        <a href="<?php echo e(route('cliente.pacotes', $cliente->id)); ?>" class="pacote">Adicionar Pacote 🎁</a> 😔</p>
                    <?php endif; ?>
                </div>

                <div class="info-block">
                    <h2>🧒 Dados da Criança</h2>
                    <p><strong>Nome:</strong> <?php echo e($cliente->nome_crianca); ?></p>
                    <p><strong>Data de Nascimento:</strong> <?php echo e($cliente->data_nascimento_crianca); ?></p>
                    <p><strong>Gênero:</strong> <?php echo e($cliente->genero_crianca); ?></p>
                    <p><strong>Observações:</strong> <?php echo e($cliente->observacoes_crianca ?? 'Não informado'); ?></p>
                </div>
...
<?php /**PATH D:\laragon\www\Origens\resources\views/mostrar.blade.php ENDPATH**/ ?>